...
class _MapPageState extends riv.ConsumerState<MapPage> {
  ...
  void initState() {
    ...
    if (widget.placeId != null) {
      Provider.of<MarkerDataProvider>(context, listen: false)
          .setSelectedLocation = widget.placeId;
      Provider.of<MarkerDataProvider>(context, listen: false)
          .setSelectedVideoId = widget.videoId;
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<MarkerDataProvider>(
      builder: (
        BuildContext consumerContext,
        MarkerDataProvider markerProvider,
        Widget? child,
      ) {
        return Scaffold(
          ...
          body: Column(
            children: [
              Expanded(
                child: Stack(
                  children: [
                    ...
                    Visibility(
                      visible:
                          _selectedLocation != null && _selectedVideoId != null,
                      child: Positioned(
                        top: 70,
                        right: 10,
                        child: SizedBox(
                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          // 실제 스크롤 되는 콘텐츠
                                          markerProvider.selectedLocation !=
                                                  null
                                              ? FutureBuilder<
                                                Map<String, dynamic>
                                              >(
                                                              ...
                                                              children: [
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    GestureDetector(
                                                                      onTap: () {
                                                                        markerProvider.setSelectedLocation =
                                                                            null;
                                                                        markerProvider.setSelectedVideoId =
                                                                            null;
                                                                        _sheetController.animateTo(
                                                                          0.4,
              ...
              BottomNavBar(context, 'map', canOpenMap: () => ref.read(userSessionProvider).currentUserUID != null,),
            ],
          ),
        );
      },
